...
### Database Overview
The data is organised in seven collections. Two were automatically generated by using file upload in MongoDB (fs.chunks and fs.files). One is unused (Votes), but not deleted to show the thinking process while designing a voting system.
